...
#import "DowFamiViewController.h"
#import <CoreText/CoreText.h>

@interface DowFamiViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (strong, nonatomic) NSString *errorMessage;
@end

@implementation DowFamiViewController
